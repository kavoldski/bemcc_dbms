                                        ...
                                        if($query->rowCount() > 0)
                                        {
                                            ...
                                            {    
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=" text-center">
                                                        <a href="#"  class=" edit_data btn btn-info rounded-circle" id="<?php echo  ($row->ID); ?>" title="click for edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>
                                                        
                                                        <a href="userregister.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Block ?');" title="Block this User" class="btn btn-danger rounded-circle"><i class="mdi mdi-block-helper"></i></a> </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1;
                                                }
                                            } ?>
